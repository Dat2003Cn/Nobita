                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single_product">
                                            <div class="product_thumb">
                                               <a href="single-product.html"><img src="assets\img\product\{{$st->img}}" alt=""></a> 
                                               <div class="img_icone">
                                            ...
                                            <div class="product_content">
                                                <span class="product_price">{{$st->price}}</span>
                                                <h3 class="product_title"><a href="single-product.html">{{$st->name}}</a></h3>
                                            </div>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single_product">
                                            ...
                                            <div class="product_content">
                                                <span class="product_price">$6{{$st->price}}</span>
                                                <h3 class="product_title"><a href="single-product.html">{{$st->name}}</a></h3>
                                            </div>
                                            <div class="product_info">
                                                <ul>
