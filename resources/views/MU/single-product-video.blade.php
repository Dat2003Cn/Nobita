                            ...
                            <div class="tab-content produc_tab_c">
                                <div class="tab-pane fade show active" id="p_tab1" role="tabpanel">
                                    <div class="modal_img">
                                        ...
                                        <div class="view_img">
                                            <a class="video_popup" href="https://www.youtube.com/watch?v=PXud93uzBbo&list=PLWTu87GngvNxpWN6FVuEcS-YvFNq6RnqG&index=33">View video <i class="fa fa-search-plus"></i></a>
                                        </div>    
                                    </div>
                                </div>
